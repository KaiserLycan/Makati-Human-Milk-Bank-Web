...
interface StaffAccessDeniedProps {
  message: string;
}

export default function StaffAccessDenied({ message }: StaffAccessDeniedProps) {
  ...
  return (
    <div className="relative min-h-screen bg-white text-neutral-900 flex flex-col justify-between overflow-x-hidden w-full">
        ...
        <div className="flex flex-col gap-8 w-full max-w-lg mx-auto text-center items-center justify-center animate-in fade-in duration-300">
          ...
          <div className="text-center">
            <p className="text-neutral-500 font-sans text-sm">
              If you require access, please contact your administrator.
            </p>
          </div>
        </div>
      </main>
